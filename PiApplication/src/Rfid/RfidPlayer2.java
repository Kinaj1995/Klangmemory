 ...
 * @author Sacredgamer
 */
public class RfidPlayer2 {
    //String pathh;

    Logger log = Logger.getLogger(RfidPlayer2.class.getName());
    ...
    public void play(String audioFileName) throws IOException {
       ...
       //pathh=this.pathh;
        ...
        while (tryAgain) {
            ...
            //Process p = Runtime.getRuntime().exec("python " + Interface.getPlayPath());
            Process p = Runtime.getRuntime().exec("python3 /home/pi/pi-rfid/"+audioFileName+".py");
     ...
     private class writer implements Runnable {
        ...
        public void run() {
            try {
                ...
                Logger.getLogger(RfidPlayer2.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
